...
public class TelaListaLogByMat extends JFrame {

	private static final long serialVersionUID = -3835113994489764167L;
	...
	public TelaListaLogByMat(ControladorLog owner) {
		super("Tabela de Registros por Matricula");
		try {
	...
	public void updateData(String numeroMatricula) {
		try {
			tabelaL.setNumRows(0);
			for (Log l : ctrlLog.buscaLogsByMatricula(numeroMatricula)) {
